...
public class SimpleLinkedListQueue2<T> implements SimpleQueue<T>, Iterable<T> {
    ...
    public Iterator<T> iterator() {
        class SimpleLinkedListQueue2Iterator implements Iterator<T> {
            ...
            @Override
            public T next() {
                T value = (T) curr.value;
                curr = curr.next;
                return value;
            }
        }

        return new SimpleLinkedListQueue2Iterator();
    }
